  ...
  for entry in dataset:
    ...
    # for qa in paragraph["qas"]:
      ...
      if is_training:
        ...
        # if (len(qa["answer"]) != 1): # answers to answer
        #   raise ValueError(
        ...
        # print('actual : ', actual_text, 'cleaned : ', cleaned_answer_text)
        # actual_text = " ".join(
        #     doc_tokens[start_position:(end_position + 1)])
        # cleaned_answer_text = " ".join(
        #     tokenization.whitespace_tokenize(orig_answer_text))
        # cleaned_answer_text = tag_clean(" ".join(tokenization.whitespace_tokenize(orig_answer_text)))
...
def convert_examples_to_features(examples, tokenizer, max_seq_length,
  ...
  for (example_index, example) in enumerate(examples):
    ...
    # if is_training and example.is_impossible: is impossible = true
    # if is_training:
    #   tok_start_position = -1
    #   tok_end_position = -1
    # if is_training and not example.is_impossible: is impossible = false
    if is_training:
...
def main(_):
  ...
  if FLAGS.do_train:
    ...
    print('num_train_steps : ', num_train_steps, 'num_warmup_steps : ',num_warmup_steps)
